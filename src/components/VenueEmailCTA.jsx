                        ...
                        >
                            <motion.div {...slideIn} className="flex-1 h-full flex items-center">
                                <input
                                    ...
                                    className={`w-full h-full px-6 bg-transparent text-[16px] md:text-sm outline-none placeholder:opacity-40 ${error ? 'placeholder:text-red-500 placeholder:opacity-70' : ''}`}
